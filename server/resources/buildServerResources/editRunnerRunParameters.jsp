...
<tr>
    ...
    <td>
        ...
        <span class="smallNote">
             Specify a version of Unity to use - e.g. 5.1.2f1
        </span>
    </td>
</tr>
...
<tr>
    ...
    <td>
        ...
        <span class="smallNote">
             Optional, specify to use alternate Unity installation path (if specifying a version of unity its best to leave blank)
        </span>
    </td>
</tr>
